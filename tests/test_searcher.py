...
from jito_py.searcher import Searcher, TipAccountsResponse, BundleStatusesResponse, BundleStatus


class TestSearcher(unittest.TestCase):
    def setUp(self):
        self.searcher = Searcher("https://mainnet.block-engine.jito.wtf/api/v1/bundles")
    ...
    def test_get_tip_accounts(self, mock_post):
        ...
        expected_response = TipAccountsResponse(
            accounts=[
                "96gYZGLnJYVFmbjzopPSU6QiEV5fGqZNyN9nmNhvrZU5",
                "HFqU5x63VTqvQss8hp11i4wVV8bD44PvwucfZ2bU7gRe",
                "Cw8CFyM9FkoMi7K7Crf6HNQqf4uEMzpKw6QNghXLvLkY",
